...
gamma = 1
num_epochs = 200 # 200 # 30

# Architecture
lstm_input_size = len(hit_action_cols) + len(hit_state_cols) # Length of hit/opp are the same
lstm_hidden_size = 512 # 64 # 512
linear1_output = 1024 # 32 # 1024
linear2_output = 1000 # 16 # 1000
linear3_output = 1
...
# Train
def train(save=True, use_mc=False) -> Tuple[TennisEvalNN, Report]:
    ...
    for e in range(num_epochs):
        ...
        for rally_idx in rally_indices:
            ...
            pos = e + (rally_idx + 1)/len(rally_indices)
